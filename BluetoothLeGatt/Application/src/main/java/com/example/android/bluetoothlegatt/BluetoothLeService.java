...
public class BluetoothLeService extends Service {
    ...
    public void setCallBack(StengthCallBack callBack)
    {
     ...
     *
     * @param characteristic Characteristic to act on.
     * @param value If the byte value to set
     */
    public void setCharacteristicValue(BluetoothGattCharacteristic characteristic,
                                              byte[] value) {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
    ...
    public interface StengthCallBack {
        void function(int stengthA, int strengthB);
    }
}
